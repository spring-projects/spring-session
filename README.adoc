...
image:https://github.com/spring-projects/spring-session/workflows/CI/badge.svg?branch=deploy-pipeline-test["Build Status", link="https://github.com/spring-projects/spring-session/actions?query=workflow%3ACI"]
