...
For more information, see the {docs-url}/spring-boot/reference/web/spring-session.html[Spring Session] portion of the Spring Boot documentation.
...
For more information, see the {docs-url}/spring-boot/reference/data/sql.html#data.sql.datasource[Configure a DataSource] portion of the Spring Boot documentation.
