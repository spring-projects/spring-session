...
Spring Session provides integration with https://docs.spring.io/spring-security/site/docs/3.0.x/reference/remember-me.html[Spring Security's Remember-me Authentication].
The support:
