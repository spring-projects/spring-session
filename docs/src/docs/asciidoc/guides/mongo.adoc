...
Alternatively, you can also delete the explicit key. Enter the following into your terminal ensuring to replace `93f7aa8578d0464280c05aed07999d33` with the value of your SESSION cookie:

	> db.sessions.remove({"_id":"93f7aa8578d0464280c05aed07999d33"})
