...
<body>
    <div class="container">
        ...
        <p>Your principal Class is: <c:out value="${pageContext.request.userPrincipal.class}"/></p>
        <p>Your assigned roles are: <c:out value="${pageContext.request.userPrincipal.principal.authorities}"/></p>
